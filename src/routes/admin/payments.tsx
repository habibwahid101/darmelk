...
function AdminPayments(){const {data,reload,loading}=useAsync(()=>api.admin.payments(),[]);const [busy,setBusy]=useState<string|null>(null);const payments=data?.payments??[];
